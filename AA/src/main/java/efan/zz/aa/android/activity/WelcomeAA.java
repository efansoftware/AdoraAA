...
//      promptInstallAAData();
  ...
  private void init()
  {
    ...
    /*
    EditText symptomText = (EditText) findViewById(R.id.symptom_search);
    symptomText.setOnEditorActionListener(new TextView.OnEditorActionListener() 
    {   // http://developer.android.com/guide/topics/ui/controls/text.html#ActionEvent
		@Override
  ...
  protected void searchSymptom(CharSequence text) {
